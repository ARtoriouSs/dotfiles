...
alias profile="$EDITOR $DOTFILES_PATH/shell/.profile"
alias bashrc="$EDITOR $DOTFILES_PATH/shell/.bashrc"
alias zprofile="$EDITOR $DOTFILES_PATH/shell/.zprofile"
alias zshrc="$EDITOR $DOTFILES_PATH/shell/.zshrc"
alias aliases="$EDITOR $DOTFILES_PATH/shell/aliases.sh"
alias functions="$EDITOR $DOTFILES_PATH/shell/functions.sh"
alias environment="$EDITOR $DOTFILES_PATH/shell/environment.sh"
alias envs="$EDITOR $DOTFILES_PATH/shell/environment.sh"
alias temp-settings="$EDITOR $DOTFILES_PATH/shell/temp_settings.sh"
alias temps="$EDITOR $DOTFILES_PATH/shell/temp_settings.sh"
alias gitconfig="$EDITOR $DOTFILES_PATH/git/.gitconfig"
alias gitignore-global="$EDITOR $DOTFILES_PATH/.gitignore_global"
alias vimrc="$EDITOR $DOTFILES_PATH/vim/.vimrc"
alias plugins="$EDITOR $DOTFILES_PATH/vim/plugins.vim"
